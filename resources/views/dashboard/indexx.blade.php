                                      ...
                                      <div class="row no-gutters align-items-center">
                                          <div class="col mr-2">
                                              <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                  Jumlah WBP</div>
                                              <div class="h5 mb-0 font-weight-bold text-gray-800">echo dari db wbp</div>
                                          </div>
                                          <div class="col-auto">
              ...
              <footer class="sticky-footer bg-white">
                  <div class="container my-auto">
                      <div class="copyright text-center my-auto">
                          <span>&copy; <a class="border-bottom" href="#">SIPINA | Lapas Kelas IIB Purwakarta</a>, All Right Reserved.</span>
                        </div>
                  </div>
              </footer>
              <!-- End of Footer -->
