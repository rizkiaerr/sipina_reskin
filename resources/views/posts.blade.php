        ...
        <div class="col-md-6">
            <form action="/posts">
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-info border-dark" type="submit" >Search</button>
                </div>
            </form>
        </div>
    </div>
...
@if($posts->count())
    <div class="card mb-3">
        ...
        @else
            <img src="/img/noimage.png" class="card-img-top" alt="{{ $posts[0]->category->name }}">
        @endif
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    ...
                    @else
                        <img src="/img/noimage.png" class="card-img-top" class="card-img-top" alt="{{ $post->category->name }}">
                    @endif
